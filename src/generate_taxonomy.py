...
def read_params(args):
    ...
    arg( '--virus_accessions',type=str,help='Virus full name and accession file generated by get_virus_accessions.py',default='virus_accessions.txt')
...
if __name__ == '__main__':
    ...
    accessions = Accessions( par['prokaryotes'], par['eukaryotes'], par['viruses'], par['scaffs_in_complete'], par['catalog'], par['virus_accessions'] )
